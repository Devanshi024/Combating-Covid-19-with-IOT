            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title mt-0">SMOKE SENSOR</h4>
                  <p class="card-category">SMOKE SENSOR HISTORY</p>
                </div>
                <div class="card-body">
				  ...
				  <?php
																...
																$query = "SELECT * FROM smoke_sensor_table";
																...
																<td><?php echo $value['SMOKE_ID'];?> </td>
																<td><?php echo $value['DEVICE_ID'];?> </td>
																<td><?php echo $value['SMOKE_VALUE'];?> </td>
																<td>
																<?php 
																
																
																 $svalue=$value['SMOKE_VALUE'];
																 if($svalue>=500)
																 {
																	 echo "SMOKE DETECTED";
																 }
