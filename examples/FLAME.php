            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title mt-0">FLAME SENSOR</h4>
                  <p class="card-category">FLAME SENSOR HISTORY</p>
                </div>
                <div class="card-body">
				  ...
				  <?php
																...
																$query = "SELECT * FROM flame_sensor_table";
																...
																<td><?php echo $value['FLAME_ID'];?> </td>
																<td><?php echo $value['DEVICE_ID'];?> </td>
																<td><?php echo $value['FLAME_VALUE'];?> </td><td>
																<?php 
																
																
																 $svalue=$value['FLAME_VALUE'];
																 if($svalue>=500)
																 {
																	 echo "FIRE DETECTED";
																 }
