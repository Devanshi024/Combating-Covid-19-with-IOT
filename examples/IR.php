            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title mt-0">IR SENSOR</h4>
                  <p class="card-category">IR SENSOR HISTORY</p>
                </div>
                <div class="card-body">
				  ...
				  <?php
																...
																<td><?php echo $value['IRS_ID'];?> </td>
																<td><?php echo $value['DEVICE_ID'];?> </td>
																<td><?php echo $value['IR_VALUE'];?> </td>
																<td>
																<?php 
																
																
																 $svalue=$value['IR_VALUE'];
																 if($svalue>=500)
																 {
																	 echo "DETECTED";
																 }
