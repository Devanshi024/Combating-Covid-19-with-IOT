            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title mt-0">TEMPSENSOR</h4>
                  <p class="card-category">THERMAL SENSOR HISTORY</p>
                </div>
                <div class="card-body">
				  ...
				  <?php
																...
																$query = "SELECT * FROM temp_sensor_table";
																...
																<td><?php echo $value['TEMP_VALUE'];?> </td>
																<td>
																<?php 
																
																
																 $svalue=$value['TEMP_VALUE'];
																 if($svalue>=500)
																 {
																	 echo "TEMP DETECTED";
																 }
