            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title mt-0">RFID SENSOR</h4>
                  <p class="card-category">RFID SENSOR HISTORY</p>
                </div>
                <div class="card-body">
				  ...
				  <?php
																...
																$query = "SELECT * FROM RFID_sensor_table";
																...
																<td><?php echo $value['RFID_ID'];?> </td>
																<td><?php echo $value['DEVICE_ID'];?> </td>
																<td><?php echo $value['RFID_VALUE'];?> </td>
																<td>
																<?php 
																
																
																 $svalue=$value['RFID_VALUE'];
																 if($svalue>=500)
																 {
