            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title mt-0">ULTRASONIC SENSOR</h4>
                  <p class="card-category">USS HISTORY</p>
                </div>
                <div class="card-body">
				  ...
				  <?php
																...
																$query = "SELECT * FROM ultrasonic_table";
																...
																<td><?php echo $value['USS_ID'];?> </td>
																<td><?php echo $value['DEVICE_ID'];?> </td>
																<td><?php echo $value['USS_VALUE'];?> </td>
																<td>
																<?php 
																
																
																 $svalue=$value['USS_VALUE'];
																 if($svalue>=500)
																 {
																	 echo "DETECTED";
																 }
