...
<head>
  ...
  <link rel="icon" type="image/png" href="../assets/img/Logofavicon1.png">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">Alert Cards</p>
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="#pablo" class="warning-link">Alert Siren buzzer...</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">GREEN CARD</p>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category">RED CARD</p>
                  <h3 class="card-title">DANGER</h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">local_offer</i> Area is at Risk
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <p class="card-category">LIMIT VALUE</p>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-12">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">FLAME SENSOR</h4>
            ...
            <div class="col-xl-4 col-lg-12">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">SMOKE SENSOR</h4>
                  <p class="card-category">SMOKE VALUE :: 450</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-xl-4 col-lg-12">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">IR SENSOR</h4>
                  <p class="card-category">IR VALUE :: 550</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i> campaign sent 2 days ago
		  ...
		  <div class="row">
            <div class="col-xl-4 col-lg-12">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">PIR SENSOR</h4>
                  <p class="card-category">
                    PIR VALUE :: 550</p>
                </div>
                <div class="card-footer">
            ...
            <div class="col-xl-4 col-lg-12">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">USS VALUE :: 450</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">access_time</i> campaign sent 2 days ago
